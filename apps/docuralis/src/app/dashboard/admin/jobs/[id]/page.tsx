      ...
      <div className="bg-white shadow-md rounded-lg p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <div className="mt-1 font-medium">{formatDate(job.createdAt)}</div>
          </div>
          <div>
            <span className="text-gray-600 text-sm">Started At</span>
            <div className="mt-1 font-medium">{formatDate(job.startedAt)}</div>
          </div>
          <div>
            <span className="text-gray-600 text-sm">Completed At</span>
            <div className="mt-1 font-medium">{formatDate(job.completedAt)}</div>
          </div>
          <div>
      ...
      <div className="bg-white shadow-md rounded-lg p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <div className="mt-1 font-medium">{job.document.originalName}</div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="mt-1 font-medium">{formatFileSize(job.document.fileSize)}</div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="mt-1 font-medium">{job.document.uploadedBy.name}</div>
          ...
          <div>
            ...
            <div className="mt-1 font-medium">{job.document.collection.name}</div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white shadow-md rounded-lg p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <div className="mt-1 font-medium">{job.document.collection.embeddingModel}</div>
          </div>
          <div>
            <span className="text-gray-600 text-sm">Chunk Size</span>
            <div className="mt-1 font-medium">{job.document.collection.chunkSize} tokens</div>
          </div>
          <div>
            <span className="text-gray-600 text-sm">Chunk Overlap</span>
            <div className="mt-1 font-medium">{job.document.collection.chunkOverlap} tokens</div>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-2">
            {job.document.chunks.map((chunk) => (
              ...
              >
                ...
                <span className="text-sm text-gray-600">{chunk.tokenCount} tokens</span>
              </div>
            ))}
          </div>
        ) : (
