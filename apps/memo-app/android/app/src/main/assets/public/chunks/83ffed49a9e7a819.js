(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    function i({ className: e, variant: n, asChild: i = !1, ...s }) {
      let l = i ? r.Slot : "span";
      return (0, t.jsx)(l, {
        "data-slot": "badge",
  ...
  (e, t, r) => {
    ...
    function v(t) {
      ...
      let n,
        a,
        o,
        [l, v] = (0, s.useOptimistic)(p.IDLE_LINK_STATUS),
        x = (0, s.useRef)(null),
        {
          href: b,
          as: j,
      ...
      let M = s.default.useContext(u.AppRouterContext),
        D = !1 !== C,
        U =
          !1 !== C
            ? null === (r = C) || "auto" === r
      ...
      let B = R ? a && "object" == typeof a && a.ref : I,
        z = s.default.useCallback(
          (e) => (
            null !== M &&
              (x.current = (0, p.mountLinkInstance)(e, $, M, U, D, v)),
            () => {
              x.current &&
        ...
        K = {
                ...
                (function (t, r, n, a, o, i, l) {
                  if ("undefined" != typeof window) {
                    ...
                    s.default.startTransition(() => {
                      d(n || r, o ? "replace" : "push", i ?? !0, a.current);
                    });
                  }
                })(t, $, F, x, S, w, A);
          },
          onMouseEnter(e) {
            R || "function" != typeof L || L(e),
              ...
              M && D && (0, p.onNavigationIntent)(e.currentTarget, !0 === T);
          },
      ...
      return (
        (0, d.isAbsoluteUrl)(F)
          ? (K.href = F)
          : (R && !P && ("a" !== a.type || "href" in a.props)) ||
            (K.href = (0, f.addBasePath)(F)),
        (o = R
          ? s.default.cloneElement(a, K)
          : (0, i.jsx)("a", { ...k, ...K, children: n })),
        (0, i.jsx)(y.Provider, { value: l, children: o })
      );
    }
    e.r(84508);
  ...
  (e) => {
    ...
    var t = e.i(43476),
      r = e.i(71689),
      n = e.i(75254);
    let a = (0, n.default)("plus", [
        ["path", { d: "M5 12h14", key: "1ays0h" }],
        ["path", { d: "M12 5v14", key: "s699le" }],
      ]),
      o = (0, n.default)("search", [
    ...
    function h() {
      let [e, n] = (0, s.useState)([]),
        [h, m] = (0, s.useState)(""),
        [g, v] = (0, s.useState)("ALL"),
        [y, x] = (0, s.useState)(!0),
        b = (0, s.useCallback)(async () => {
          try {
            x(!0);
            let e = new URLSearchParams();
            "ALL" !== g && e.append("status", g), h && e.append("search", h);
            let t = await fetch(`/api/memos?${e}`),
              r = await t.json();
            n(r.data || []);
          } catch (e) {
      ...
      let j = e.filter(
        (e) =>
          ...
          e.content.toLowerCase().includes(h.toLowerCase()),
      );
      return (0, t.jsx)("div", {
                  ...
                  (0, t.jsxs)("div", {
                    ...
                    children: [
                      ...
                      (0, t.jsx)("p", {
                        ...
                        children: "Manage and track your memos",
                      }),
                    ],
                  }),
                  (0, t.jsx)(i.default, {
              ...
              (0, t.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, t.jsxs)(f.Select, {
                    ...
                    onValueChange: (e) => v(e),
                    children: [
                      (0, t.jsx)(f.SelectTrigger, {
                        className: "w-[180px]",
                        children: (0, t.jsx)(f.SelectValue, {
                          placeholder: "Filter by status",
                        }),
                      }),
                      (0, t.jsxs)(f.SelectContent, {
                        children: [
                          (0, t.jsx)(f.SelectItem, {
                            value: "ALL",
                            children: "All Status",
                          }),
                          (0, t.jsx)(f.SelectItem, {
                  ...
                  : (0, t.jsx)("div", {
                      ...
                      children: j.map((e) =>
                        (0, t.jsx)(
                          ...
                          {
                            href: `/memos/${e.id}`,
                            children: (0, t.jsxs)(c.Card, {
                              className:
                                "h-full hover:border-primary transition-colors cursor-pointer",
                              children: [
