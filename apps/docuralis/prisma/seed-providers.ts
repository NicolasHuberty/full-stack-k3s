  ...
  const providers = [
    {
      ...
      displayName: 'OpenAI',
      description:
        'OpenAI provides state-of-the-art language models including GPT-4 and GPT-3.5',
    ...
    },
    {
      ...
      description:
        'Anthropic develops Claude, a helpful, harmless, and honest AI assistant',
    ...
    },
    {
      ...
      description:
        'Mistral AI offers powerful open-source and commercial language models',
