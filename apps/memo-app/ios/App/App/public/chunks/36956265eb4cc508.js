    ...
    function m(t) {
      ...
      let D = M ? o && "object" == typeof o && o.ref : x,
        K = a.default.useCallback(
          (e) => (
            null !== $ &&
              (P.current = (0, d.mountLinkInstance)(e, F, $, k, I, m)),
            () => {
              P.current &&
                ((0, d.unmountLinkForCurrentNavigation)(P.current),
                (P.current = null)),
        ...
        z = {
          ...
          onMouseEnter(e) {
            M || "function" != typeof N || N(e),
              ...
              $ && I && (0, d.onNavigationIntent)(e.currentTarget, !0 === A);
          },
